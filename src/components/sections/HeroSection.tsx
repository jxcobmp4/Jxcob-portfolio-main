...
<a
  href="#contact"
  className="inline-flex items-center gap-4 lg:gap-6 px-2.5 pl-6 lg:pl-8 py-2.5 text-sm font-medium text-[#ffffff] bg-[var(--color-accent)] rounded-full hover:bg-[#6D28D9] transition-colors btn-glow"
>
  Trabaja conmigo
